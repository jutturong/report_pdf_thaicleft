...
$pdf->SetFont('angsana','',15);
$pdf->MultiCell( 0  , 0 , iconv( 'UTF-8','cp874' ,'the 8 th Annual Meeting of the Thai Cleft Lip - Palate and Craniofacial Association : '.'' )); 


$pdf->setXY( 10, $y_absolute +  ($r*13)  );
$pdf->SetFont('angsana','',15);
$pdf->MultiCell( 0  , 0 , iconv( 'UTF-8','cp874' ,'Sincerely, '.'' )); 
...
$pdf->Image('2.png',20,120,25,0,'','');//Image(string file [, float x [, float y [, float w [, float h [, string type [, mixed link]]]]]])
